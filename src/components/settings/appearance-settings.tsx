            ...
            {themes.map((theme) => {
              ...
              return (
                <button
                  ...
                  className={`flex flex-col items-center gap-2 sm:gap-3 rounded-xl border p-4 sm:p-6 transition-all duration-200 ${
                    isActive
                ...
                >
                  <Icon
                    className={`h-8 w-8 sm:h-10 sm:w-10 ${isActive ? 'text-primary' : 'text-muted-foreground'}`}
                  />
                  <span
