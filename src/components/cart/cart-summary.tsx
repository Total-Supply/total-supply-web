...
export function CartSummary({
  ...
  return (
    <div className="rounded-2xl border border-border/60 bg-gradient-to-br from-card/90 to-card/60 p-5 sm:p-6 shadow-lg">
      <div className="space-y-5 sm:space-y-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="rounded-xl border border-border/60 bg-gradient-to-br from-card/50 to-card/30 p-3">
        ...
        {/* Trust Badges */}
        <div className="space-y-2 rounded-xl border border-border/60 bg-gradient-to-br from-card/50 to-card/30 p-3">
